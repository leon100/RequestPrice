...
namespace Leon\RequestPrice\Controller\Adminhtml;

abstract class Bid extends \Magento\Backend\App\Action
{

    const ADMIN_RESOURCE = 'Leon_RequestPrice::leon_requestprice_bid';
    ...
    public function initPage($resultPage)
    {
        $resultPage->setActiveMenu(self::ADMIN_RESOURCE)
            ->addBreadcrumb(__('Leon'), __('Leon'))
            ->addBreadcrumb(__('Bid'), __('Bid'));
        return $resultPage;
    }
}
